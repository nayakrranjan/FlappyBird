...
public class FlappyBird implements ActionListener, MouseListener, KeyListener
{
    ...
    public void addColumn(boolean start)
    {
        ...
        {
            columns.add(new Rectangle(columns.get(columns.size() - 1).x + 400, HEIGHT - height - 100, width, height));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (started)
        {
            ...
            {
                if (column.y == 0 && bird.x + bird.width / 1 > column.x + column.width / 1 - 10 && bird.x + bird.width / 1 < column.x + column.width / 1 + 10)
                {
                    score++;
                }
    ...
    public void repaint(Graphics g)
    {
        ...
        g.fillRect(0, HEIGHT - 100, WIDTH, 70);
